...
> = {
  ...
  google: {
    nameKey: "providers.google.name",
    descriptionKey: "providers.google.description",
    colors:
  ...
  keycloak: {
    ...
    colors:
      "hover:bg-teal-50/80 hover:border-teal-200/50 hover:shadow-teal-100/50 dark:hover:bg-teal-950/20 dark:hover:border-teal-800/50",
