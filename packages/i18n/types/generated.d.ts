...
export type WelcomeKeys = "welcome.title" | "welcome.description";
...
export type ErrorKeys = "clerkAuth.loginSuccess.action" | "clerkAuth.loginSuccess.desc" | "clerkAuth.loginSuccess.title" | "error.backHome" | "error.desc" | "error.retry" | "error.title" | "fetchError.detail" | "fetchError.title" | "import.importConfigFile.description" | "import.importConfigFile.title" | "import.incompatible.description" | "import.incompatible.title" | "loginRequired.desc" | "loginRequired.title" | "notFound.backHome" | "notFound.check" | "notFound.desc" | "notFound.title" | "pluginSettings.desc" | "pluginSettings.title" | "response.400" | "response.401" | "response.403" | "response.404" | "response.405" | "response.406" | "response.407" | "response.408" | "response.409" | "response.410" | "response.411" | "response.412" | "response.413" | "response.414" | "response.415" | "response.416" | "response.417" | "response.422" | "response.423" | "response.424" | "response.426" | "response.428" | "response.429" | "response.431" | "response.451" | "response.499" | "response.500" | "response.501" | "response.502" | "response.503" | "response.504" | "response.505" | "response.506" | "response.507" | "response.509" | "response.510" | "response.520" | "response.522" | "response.524" | "response.AgentRuntimeError" | "response.ConnectionCheckFailed" | "response.CreateMessageError" | "response.ExceededContextWindow" | "response.FreePlanLimit" | "response.InsufficientQuota" | "response.InvalidAccessCode" | "response.InvalidBedrockCredentials" | "response.InvalidClerkUser" | "response.InvalidGithubToken" | "response.InvalidOllamaArgs" | "response.InvalidProviderAPIKey" | "response.InvalidVertexCredentials" | "response.LocationNotSupportError" | "response.ModelNotFound" | "response.NoOpenAIAPIKey" | "response.OllamaBizError" | "response.OllamaServiceUnavailable" | "response.PermissionDenied" | "response.PluginApiNotFound" | "response.PluginApiParamsError" | "response.PluginFailToTransformArguments" | "response.PluginGatewayError" | "response.PluginManifestInvalid" | "response.PluginManifestNotFound" | "response.PluginMarketIndexInvalid" | "response.PluginMarketIndexNotFound" | "response.PluginMetaInvalid" | "response.PluginMetaNotFound" | "response.PluginOpenApiInitError" | "response.PluginServerError" | "response.PluginSettingsInvalid" | "response.ProviderBizError" | "response.QuotaLimitReached" | "response.StreamChunkError" | "response.SubscriptionKeyMismatch" | "response.SubscriptionPlanLimit" | "response.SystemTimeNotMatchError" | "response.UnknownChatFetchError" | "stt.responseError" | "tts.responseError" | "unlock.addProxyUrl" | "unlock.apiKey.description" | "unlock.apiKey.title" | "unlock.closeMessage" | "unlock.confirm" | "unlock.oauth.description" | "unlock.oauth.success" | "unlock.oauth.title" | "unlock.oauth.welcome" | "unlock.password.description" | "unlock.password.placeholder" | "unlock.password.title" | "unlock.tabs.apiKey" | "unlock.tabs.password" | "upload.desc" | "upload.fileOnlySupportInServerMode" | "upload.networkError" | "upload.title" | "upload.unknownError" | "upload.uploadFailed";
