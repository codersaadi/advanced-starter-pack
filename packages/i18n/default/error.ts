export default {
  ...
  response: {
    ...
    '407':
      'Sorry, you need to authenticate the proxy before continuing with this request',
    '408':
    ...
    '411':
      'Sorry, the server cannot process the request without a valid content length',
    '412':
    ...
    '414':
      'Sorry, the URI of your request is too long for the server to process',
    '415':
      'Sorry, the server cannot process the media format attached to the request',
    ...
    '426':
      'Sorry, the server requires your client to upgrade to a higher protocol version',
    '428':
    ...
    '451':
      'Sorry, the server refuses to provide this resource due to legal reasons',
    '499':
    ...
    '509':
      "Sorry, the server's bandwidth has been exhausted. Please try again later.",
    '510':
    ...
    InsufficientQuota:
      'Sorry, the quota for this key has been reached. Please check your account balance or increase the key quota and try again.',
    InvalidAccessCode:
    ...
    NoOpenAIAPIKey:
      'OpenAI API Key is empty, please add a custom OpenAI API Key',
    OllamaBizError:
    ...
    QuotaLimitReached:
      'We apologize, but the current token usage or number of requests has reached the quota limit for this key. Please increase the quota for this key or try again later.',
    StreamChunkError:
  ...
  stt: {
    responseError:
      'Service request failed, please check the configuration or try again',
  },
  tts: {
    responseError:
      'Service request failed, please check the configuration or try again',
  ...
  upload: {
    ...
    title:
      'File upload failed. Please check your network connection or try again later',
