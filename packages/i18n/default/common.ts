export default {
  ...
  autoGenerateTooltipDisabled:
    "Please enter a tooltip before using the autocomplete feature",
  back: "Back",
  batchDelete: "Batch Delete",
  blog: "Product Blog",
  branching: "Create Subtopic",
  branchingDisable:
    "The 'Subtopic' feature is only available in the server version. If you need this feature, please switch to server deployment mode or use LobeChat Cloud.",
  cancel: "Cancel",
  changelog: "Changelog",
  clientDB: {
    autoInit: {
