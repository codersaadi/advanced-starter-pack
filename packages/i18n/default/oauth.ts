export default {
  ...
  failed: {
    ...
    subTitle: 'You have denied the application access to your  account',
  ...
  login: {
    ...
    description:
      'The application {{clientName}} is requesting to use your account for login',
    title: 'Login to {{clientName}}',
    userWelcome: 'Welcome back, ',
  },
  success: {
    subTitle:
      'You have successfully authorized the application to access your  account. You can close this page now.',
