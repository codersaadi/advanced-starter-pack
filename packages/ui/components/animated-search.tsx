  ...
  const renderSearchInput = () => (
    <div
      className={cn(
        ...
        'border border-input bg-background hover:border-accent',
        'flex items-center',
        sizeConfig.container,
        expanded ? sizeConfig.expandedWidth : 'w-8',
        isFocused && 'ring-1 ring-ring',
        expanded ? 'gap-2 px-3' : iconPosition === 'left',
        // ? 'pl-3 pr-2'
        // : 'pr-3 pl-2',
    ...
    <div className={containerClassName}>
      ...
      >
        ...
        {expanded && renderResults && (
          <div className="absolute top-full left-0 mt-2 w-full rounded-md border border-input bg-background shadow-lg">
            {renderResults(searchValue)}
          </div>
        )}
      </form>
