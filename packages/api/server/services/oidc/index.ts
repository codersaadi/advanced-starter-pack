...
import { createContextForInteractionDetails } from '@repo/api/libs/oidc-provider/http-adapter';
import type { OIDCProvider } from '@repo/api/libs/oidc-provider/provider';
