...
// NOTE :
// The utility is largely compatible with Edge environments due to its focus on headers and its graceful handling of the optional ipaddr.js dependency. The parts relying on Node.js-specific socket and connection properties will not function on the Edge but won't break the utility either; they'll just be skipped.
